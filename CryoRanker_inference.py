...
def features_n_kmeans(mrcArray_features, k, cut_ratio, job=None, merge_threshold=0.25, centers_sampling=True, n_runs=10):
...
def cryo_select_main(cfg=None,job_path=None,cache_file_path=None,accelerator=None,use_features=False,features_max_num=1000000):
    ...
    # if cfg['scores_cut']['is_scores_cut']:
    #     results_scores_cut(cfg, accelerator)
