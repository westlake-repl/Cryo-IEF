...
new_particles_cs, confidence, features_all = CryoRanker_inference.cryoRanker_main(job_path=(str)(dealjobs.cshandle.find_project(dealjobs.project).dir()) + '/' + source_particle_job + '/', cache_file_path=model_cache_file_path, accelerator=accelerator, use_features=if_initial_orientation_balance, features_max_num=len(source_particles_cs))
