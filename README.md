...
Model weights are accessible via [Cryo-IEF Huggingface](https://huggingface.co/westlake-repl/Cryo-IEF/tree/main/cryo_ief_checkpoint) and [CryoRanker Huggingface](https://huggingface.co/westlake-repl/Cryo-IEF/tree/main/cryo_ranker_checkpoint). 
