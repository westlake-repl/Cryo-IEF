...
Model weights are accessible via [Cryo-IEF Huggingface](https://huggingface.co/westlake-repl/Cryo-IEF/tree/main/cryo_ief_checkpoint/cryo_ief_v1_vit_b) and [CryoRanker Huggingface](https://huggingface.co/westlake-repl/Cryo-IEF/tree/main/cryo_ranker_checkpoint). 
